...
It renames all the occurrences of rby1_ext (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the rby1_ext folder
        os.rename(
            os.path.join(root_dir_path, "exts", "rby1_ext", "rby1_ext"),
            os.path.join(root_dir_path, "exts", "rby1_ext", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "rby1_ext"), os.path.join(root_dir_path, "exts", new_name))
